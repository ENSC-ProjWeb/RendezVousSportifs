...
<div id='zoneConnexion'>
        ...
        <table>
            <tr>
                <td colspan="2"><?php echo $dataView['nbEventToCome']; ?> &eacute;v&eacute;nement(s) à venir</td>
            </tr>
            <tr>
                <td colpan="2"><?php echo $dataView['nbEventWaiting']; ?> &eacute;v&eacute;nements en attente</td>
            </tr>
            <tr>
